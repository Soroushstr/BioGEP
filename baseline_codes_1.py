...
from new_pipeline_1 import train
from new_pipeline_1 import test
import torch
...
results = train(graphs, model, model_path="ara_model.pt", weighted_sampling=False)
...
test_graphs, _ = build_dataset("/gpfs/data/fs72129/imansamiei/soroush/GEPNew/data/bacillus_genes.fasta", 
                               ...
                               vocab = vocab)
results_test = test(graphs=test_graphs, model=model, model_path="ara_model.pt")
print("Bacillus test")
print(results_test)
